...
function EditEmp() {
  ...
  if (!state) return <p className="text-center text-red-500 text-3xl">No employee data provided</p>;
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(saveModifiedEmp)} className="max-w-md mx-auto mt-10">
        ...
        <button type="submit" className="text-2xl rounded-2xl bg-pink-400 text-white block mx-auto p-4">
          Save
        </button>
      </form>
    </div>
